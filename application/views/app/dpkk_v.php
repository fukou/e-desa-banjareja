				...
				<form>
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control" id="nik_pemohon" required>
						</div>
						<div class="form-group col-md-6">
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="alasan_pemohon">Alasan Permohonan</label>
							<input type="text" class="form-control" id="alasan_pemohon">
						</div>
						<div class="form-group col-md-6">
...
<!-- firebase app -->
<script src="<?php echo base_url();?>assets/js/app/dpkk.js"></script>
