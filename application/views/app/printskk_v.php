...
<body>
	...
	<div style="text-align:center; font-size:20px;"><b>Surat Keterangan Kelahiran</b></div>
		<table style="margin:0 30px 0 30px">
			...
			<tr><td colspan="3"><b>JENAZAH</b></td></tr>
			<tr class="spaceUnder">
				<td>NIK</td>
				<td>:</td>
				<td><span id="nik_jenazah"></span></td>	
			</tr>
			<tr class="spaceUnder">
				<td>Nama Lengkap</td>
				<td>:</td>
				<td><span id="nama_jenazah"></span></td>	
			</tr>
			<tr class="spaceUnder">
				<td>Jenis Kelamin</td>
				<td>:</td>
				<td><span id="jekel_jenazah"></span></td>
			</tr>
			<tr class="spaceUnder">
				<td>Tanggal lahir/umur</td>
				<td>:</td>
				<td><span id="tl_jenazah"></span></td>
			</tr>
			<tr class="spaceUnder">
				<td>Tempat lahir</td>
				<td>:</td>
				<td><span id="tempat_lahir_jenazah"></span></td>
			</tr>
			<tr class="spaceUnder">
				<td>Agama</td>
				<td>:</td>
				<td><span id="agama_jenazah"></span></td>
			</tr>
			<tr class="spaceUnder">
				<td>Pekerjaan</td>
				<td>:</td>
				<td><span id="pekerjaan_jenazah"></span></td>
			</tr>
			<tr class="spaceUnder">
				<td>Alamat</td>
				<td>:</td>
				<td><span id="alamat_jenazah"></span></td>
			</tr>
			<tr class="spaceUnder">
				<td>Anak Ke</td>
				<td>:</td>
				<td><span id="anak_ke"></span></td>
			</tr>
			<tr class="spaceUnder">
				<td>Tanggal Kematian</td>
				<td>:</td>
				<td><span id="tl_mati"></span></td>
			</tr>
			<tr class="spaceUnder">
				<td>Pukul</td>
				<td>:</td>
				<td><span id="pukul_mati"></span></td>
			</tr>
			<tr class="spaceUnder">
				<td>Sebab Kematian</td>
				<td>:</td>
				<td><span id="sebab_kematian"></span></td>
			</tr>
			<tr class="spaceUnder">
				<td>Tempat Kematian</td>
				<td>:</td>
				<td><span id="tempat_kematian"></span></td>
			</tr>
			<tr class="spaceUnder">
				<td>Yang menerangkan</td>
				<td>:</td>
				<td><span id="yang_menerangkan"></span></td>
			</tr>
			<!-- Ayah -->
	...
	<script src="<?php echo base_url();?>assets/js/app/print/skk_p.js"></script>
</body>
