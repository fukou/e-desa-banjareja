...
<head>
	...
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#3E1D6D', endColorstr='#092756',GradientType=1 ); */
			...
			background: url('<?php base_url() ?>assets/img/desa.jpg');
			/* Full height */
			height: 100%;
...
<body>
	<div class="login">
		<h1 style="color:green;"><strong>e-Desa</strong></h1>
		<?php
		...
		<form>
			...
			<?= form_error("password"); ?>
			<button class="btn btn-primary btn-block btn-large" id="login">Login</button>
		</form>
	</div>
    <script>
